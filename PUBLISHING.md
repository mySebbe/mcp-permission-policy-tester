...
1. Create the GitHub repository at `https://github.com/mySebbe/mcp-permission-policy-tester`.
2. Create the PyPI project named `mcp-permission-policy-tester`.
3. In PyPI, add a Trusted Publisher for:
   - Owner: `mySebbe`
   - Repository: `mcp-permission-policy-tester`
